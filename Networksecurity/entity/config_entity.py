...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.valid_test_file_path:str=os.path.join(self.data_validation_dir,training_pipeline.TRAIN_FILE_NAME)
        ...
        self.data_drift_report_file_path:str=os.path.join(self.data_validation_dir,
                                                          training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR,
                                                          training_pipeline.DATA_VALIDATION_DRIFT_REPORT_FILE_NAME)
        
class DataTransformationConfig:
    def __init__(self,traning_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir:str=os.path.join(traning_pipeline_config.artifact_dir,training_pipeline.DATA_TRANSFORMATION_DIR_NAME)
...
class ModelTrainerConfig:
    def __init__(self,traning_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_trainer_dir:str=os.path.join(traning_pipeline_config.artifact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME)
        
        self.model_trained_file_path:str=os.path.join(self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,
